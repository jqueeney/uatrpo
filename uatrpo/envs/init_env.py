...
from uatrpo.envs.wrappers.normalize_wrapper import NormEnv
...
def init_env(env_type,env_name,task_name,
    ...
    if env_type == 'gym':
        from uatrpo.envs.wrappers.gym_wrapper import make_gym_env
        env_raw = make_gym_env(env_name)
    elif env_type == 'dmc':
        from uatrpo.envs.wrappers.dmc_wrapper import make_dmc_env
