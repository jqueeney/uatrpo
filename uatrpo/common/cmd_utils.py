...
parser.add_argument('--alg_name',help='algorithm',type=str,default='uatrpo')
...
ac_kwargs = [
    ...
    'delta_kl','eps_tv','trust_vary',
    'cg_it','trust_sub','kl_maxfactor','trust_damp',
    'm','c','alpha','shrink','ua_trust_damp','ua_nbatch','vectorized_map',
    'adversary_mult','adversary_nbatch'
]
...
parser.add_argument('--delta_kl',help='KL trust region parameter',
    type=float,default=0.02)
parser.add_argument('--eps_tv',
    help='TV trust region parameter (PPO clipping parameter)',type=float)
parser.add_argument('--trust_vary',
...
parser.add_argument('--m',
    help='number of random projections',type=int,default=200)
parser.add_argument('--c',
    help='trust region trade-off parameter',type=float,default=0.1)
parser.add_argument('--alpha',
    help='confidence parameter',type=float,default=0.05)
parser.add_argument('--shrink',
    help='covariance shrinkage to diagonal',type=float,default=0.0)
parser.add_argument('--ua_trust_damp',
    help='UA trust region damping coefficient',type=float,default=0.00)
parser.add_argument('--ua_nbatch',
    help='number of minibatch gradients',type=int,default=256)
parser.add_argument('--vectorized_map',
    help='use vectorized_map instead of map_fn',action='store_true')

# Adversarial gradient noise kwargs
parser.add_argument('--adversary_mult',
    help='multiple of standard error for adversarial gradient noise calc',
    type=float,default=0.0)
parser.add_argument('--adversary_nbatch',
    help='number of minibatch gradients for adversarial gradient noise calc',
